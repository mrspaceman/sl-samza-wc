...
public class ReadFileKafka {
    private static final Logger log = LoggerFactory.getLogger(ReadFileKafka.class);
    ...
    private static Producer<Long, String> createProducer() {
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "SLWordCount");
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            dumpArgs(args);
            try {
                new ReadFileKafka().runProducer(args[0]);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
